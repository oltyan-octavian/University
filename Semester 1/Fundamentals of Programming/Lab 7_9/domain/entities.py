...
class linking:
    def __init__(self, nrlab, nrprob, idstud, nota):
        self.__nrlab = nrlab
        self.__nrprob = nrprob
    ...
    def __eq__(self, other):
        if self.__nrlab == other.getNrlab() and self.__nrprob == other.getNrprob() and self.__idstud == other.getIdStud():
            return True
        return False

    def __str__(self):
        return "Id student: " + str(self.__idstud) + '; Numar laborator: ' + str(self.__nrlab) + '; Numar problema: ' + str(self.__nrprob) + '; Nota: ' + str(self.__nota)
